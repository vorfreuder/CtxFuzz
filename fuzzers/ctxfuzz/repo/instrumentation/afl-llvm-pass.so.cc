...
/* There is a problem with Ubuntu 18.04 and llvm 6.0 (see issue #63).
   ...
   disable this optional optimization for LLVM 6.0.0 and Linux */
#if 0 // CTXHTfuzz doesn't need this optimization.
      ...
      get_prev_xor_cur(IRB, CurLoc, PrevLocTrans);
...
//       }
        ...
        context_heap_operation_capture(M, BB, IRB, AFLMapPtr);
